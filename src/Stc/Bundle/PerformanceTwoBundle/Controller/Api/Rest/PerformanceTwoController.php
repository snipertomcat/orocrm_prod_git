...
namespace Stc\Bundle\PerformanceTwoBundle\Controller\Api\Rest;
 ...
 * @NamePrefix("stc_api_")
 */
class PerformanceTwoController extends FOSRestController implements ClassResourceInterface
{
    /**
    ...
    /**
     * Delete PerformanceTwo
     *
     * @ApiDoc(
     * description="Delete PerformanceTwo",
     * resource=true,
     * requirements={
     * {"name"="id", "dataType"="integer"},
     * }
     * )
     * @Acl(
     * id="stc_api_delete_performancetwo",
     * type="entity",
     ...
     *
     */
    public function deletePerformanceTwoAction(PerformanceTwo $performancetwo)
    {
        $this->getDoctrine()->getManager()->remove($performancetwo);
